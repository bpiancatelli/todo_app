...
android.permissions = RECEIVE_BOOT_COMPLETED,POST_NOTIFICATIONS,WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE,FOREGROUND_SERVICE,FOREGROUND_SERVICE_DATA_SYNC
android.api = 34
android.minapi = 26
android.ndk = 28c
p4a.branch = master
